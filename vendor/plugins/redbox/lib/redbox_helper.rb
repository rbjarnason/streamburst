module RedboxHelper
  ...
  def link_to_close_redbox_and_flv(name, html_options = {})
    link_to_function name, '$("flash_player").sendEvent("stop");sendFlvPlayerEvent("top_rotation_player","next");RedBox.close()', html_options
  end
