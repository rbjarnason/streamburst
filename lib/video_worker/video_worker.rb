...
options = {
    ...
    :monitor    => true,
    :log_output => true,
    :script     => ENV['RAILS_ENV'] == "development" ? "/home/robert/work/ContentStoreDevelopment/lib/video_worker/video_worker_daemon.rb" : "/home/robert/work/ContentStoreProductionV2/lib/video_worker/video_worker_daemon.rb" 
  }
